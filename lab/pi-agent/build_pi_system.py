...
One tight landscape teaching board (companion to whiteboards/pi-chart-prompt.md):
...
Run:  python lab/pi-agent/build_pi_system.py
"""
...
sys.path.insert(0, str(pathlib.Path(__file__).resolve().parents[2]))  # repo root, for scripts/

from scripts.whiteboard import style as S  # noqa: E402
from scripts.whiteboard.style import INK, PAL  # noqa: E402

OUT = pathlib.Path(__file__).resolve().parent / "whiteboards"
