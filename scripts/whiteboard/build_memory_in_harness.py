...
Three vendors compete over one box of a seven-box diagram.
    ...
    .venv/bin/python -m scripts.whiteboard.build_memory_in_harness
"""
...
from scripts.whiteboard import style as S
...
if __name__ == "__main__":
    from scripts.whiteboard.build_waku_architecture import write_svg_proxy
